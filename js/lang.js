...
sv:{
  ...
  tabs:{laget:"Läget",utforska:"Utforska",regioner:"Regioner",metod:"Metod",karta:"Karta"},
  ...
  gapTitle:"Rapporterad ohälsa mot behandling",
  ...
  gapLine:"behandling som behovet förutsäger",
  causalNote:"Ett samband är inte en orsak. Regioner skiljer sig åt av många skäl som den här grafen inte visar.",
  pieces:[
    {tag:"Behandlingsgapet",inst:"reg",h:"Där avståndet är störst",p:"Regionen där flest uppger psykisk ohälsa och färst får behandling, 2024."},
    {tag:"Livsloppet",inst:"mort",h:"De äldsta männen",p:"Suicidtalet bland män 85+ är landets högsta. Enkäten slutar vid 84, så gruppen syns inte i något mått på självrapporterad ohälsa."},
    {tag:"Förskrivning",inst:"reg",h:"Unga kvinnor, 20 år av ökning",p:"Uthämtade antidepressiva bland kvinnor 15–24 sedan registret startade 2006."}
  ],
  ...
  gapPos:"Regionens läge i behandlingsgapet",gapPosU:"avvikelse från förutsagd behandling · 2024",
...
en:{
  ...
  tabs:{laget:"The picture",utforska:"Explore",regioner:"Regions",metod:"Method",karta:"Map"},
  ...
  gapTitle:"Reported distress against treatment",
  ...
  gapLine:"treatment predicted by reported need",
  causalNote:"A relationship is not a cause. Regions differ for many reasons this chart does not show.",
  pieces:[
    {tag:"Treatment gap",inst:"reg",h:"Where the distance is widest",p:"The region where most report poor mental health and fewest are treated, 2024."},
    {tag:"Life course",inst:"mort",h:"The oldest men",p:"Suicide among men 85+ is the country's highest rate. The survey stops at 84, so the group appears in no measure of self-reported health."},
    {tag:"Prescribing",inst:"reg",h:"Young women, 20 years of increase",p:"Antidepressants dispensed to women 15–24 since the register began in 2006."}
  ],
  ...
  gapPos:"Where the region sits on the gap",gapPosU:"residual from predicted treatment · 2024",
