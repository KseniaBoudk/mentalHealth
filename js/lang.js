...
sv:{
  ...
  tabs:{laget:"Läget",over_tid:"Över tid",karta:"Karta",behov:"Behov & vård",sjukskrivning:"Sjukskrivning",policy_news:"Nyheter & Policy",kon:"Jämförelse efter kön",alder:"Jämförelse efter ålder",sammanhang:"Sammanhang",jamlikhet:"Jämlikhet",vantetider:"Väntetider, BUP",hbsc:"Skolbarns hälsovanor",metod:"Metod",regioner:"Länsprofil"},
  ...
  equityLead:"Samma fråga som \"Svår ängslan, oro eller ångest\" i Över tid — men uppdelad på utbildningsnivå, inkomst och födelseland i stället för region. Källan publicerar dessa uppdelningar bara på riksnivå.",
  equityNoteL:"Riksnivå, inte jämförbart med de regionala diagrammen",
  equityNoteB:"Dessa tre diagram kommer från separata tabeller hos Folkhälsomyndigheten som inte har någon regionindelning — det går alltså inte att se utbildnings- eller inkomstskillnader per län här. Täckningen är dessutom glesare än regiontabellens: bara 2021, 2022 och 2024 har publicerade siffror för den här frågan. Åldersgränsen skiljer sig också mellan diagrammen — 25 år och äldre för utbildning, 16 år och äldre för inkomst och födelseland — så jämför inte nivåerna mellan dem rakt av.",
  equityBd:{education:"Efter utbildningsnivå",income:"Efter inkomst",birth_country:"Efter födelseland"},
  equityCat:{
    education:{primary:"Förgymnasial",secondary:"Gymnasial",post_secondary:"Eftergymnasial"},
    income:{q1:"Kvintil 1 (lägst)",q2:"Kvintil 2",q3:"Kvintil 3",q4:"Kvintil 4",q5:"Kvintil 5 (högst)"},
    birth_country:{sweden:"Sverige",other_nordic:"Övriga Norden",other_europe:"Övriga Europa",other_world:"Övriga världen"},
  },
  equitySrc:"Folkhälsomyndigheten Folkhälsodata (Nationella folkhälsoenkäten / HLV)",
  ...
  realCaveat:{
    ...
    psych:"Uppdelat på 78 enskilda ICD-10-koder grupperade i 11 kapitel, årsvis, alla åldrar och kön — men bara specialistvård. Se typväljaren och not nedan.",
  ...
  // 78 ICD-10 codes and antidep's five ATC classes are each their own
  // distinct set of names) so views.js doesn't need to know which of two
  // objects to read from. The 78 code labels are Socialstyrelsen's own
  // official Swedish ICD-10 text for each code (captured live against the
  // API — same source psychBlocks' block labels below come from), not
  // paraphrased, so they can be trusted as the precise clinical name.
  lblType:"Typ",
  typeAll:"Alla typer",
  psychMedTypes:{
    ...
    F11:"Psykiska störningar och beteendestörningar orsakade av opioider",
    ...
    F15:"Psykiska störningar och beteendestörningar orsakade av andra stimulantia, däribland koffein",
    ...
    F53:"Psykiska störningar och beteendestörningar sammanhängande med barnsängstiden, vilka ej klassificeras på annan plats",
    F54:"Psykologiska faktorer och beteendefaktorer med betydelse för störningar eller sjukdomar som klassificeras på annan plats",
    ...
    F88:"Andra specificerade störningar av psykisk utveckling",
    F89:"Ospecificerad störning av psykisk utveckling",
  ...
  // The 11 ICD-10 blocks PSYCH_TYPES' 78 codes group under (js/data.js's
  // PSYCH_BLOCKS/PSYCH_CODE_BLOCK) — used only as <optgroup> headers in the
  // psychiatric-care type picker (viewOverTid/viewKarta, js/views.js), so a
  // reader picking a specific diagnosis still sees it organized under the
  // broader chapter name they may already recognize.
  psychBlocks:{
    b0501:"01 – Organiska, inklusive symtomatiska, psykiska störningar",
    b0502:"02 – Psykiska störningar och beteendestörningar orsakade av psykoaktiva substanser",
    b0503:"03 – Schizofreni, schizotypa störningar och vanföreställningssyndrom",
    b0504:"04 – Förstämningssyndrom",
    b0505:"05 – Neurotiska, stressrelaterade och somatoforma syndrom",
    b0506:"06 – Beteendestörningar förenade med fysiologiska rubbningar och fysiska faktorer",
    b0507:"07 – Personlighetsstörningar och beteendestörningar hos vuxna",
    b0508:"08 – Psykisk utvecklingsstörning",
    b0509:"09 – Störningar av psykisk utveckling",
  ...
  notNumB:{
    ...
    psych:"Räknar endast specialistvård. Det mesta av vanlig depression sköts i primärvården och syns inte här alls. Varje typ i väljaren är en enskild ICD-10-kod (International Classification of Diseases, utgåva 10), grupperad efter sitt kapitel — inte en bred kapitelsiffra som \"ätstörningar\" eller \"ADHD\", där den namngivna diagnosen bara var den vanligaste av flera olika sjukdomar i samma grupp.",
...
en:{
  ...
  tabs:{laget:"The picture",over_tid:"Over time",karta:"Map",behov:"Need & care",sjukskrivning:"Sickness absence",policy_news:"Policy & News",kon:"Comparison by sex",alder:"Comparison by age",sammanhang:"Context",jamlikhet:"Equity",vantetider:"Waiting times, BUP",hbsc:"School health habits",metod:"Method",regioner:"County profile"},
  ...
  equityLead:"The same question as \"Severe anxiety, worry or dread\" on Over time — but broken down by education level, income, and country of birth instead of region. The source only publishes these breakdowns at national level.",
  equityNoteL:"National level, not comparable to the regional charts",
  equityNoteB:"These three charts come from separate Folkhälsomyndigheten tables that have no region dimension at all — so education or income differences by county aren't visible here. Coverage is also sparser than the region table's: only 2021, 2022, and 2024 have published figures for this question. The age floor also differs between charts — 25 and up for education, 16 and up for income and country of birth — so don't compare levels across them directly.",
  equityBd:{education:"By education level",income:"By income",birth_country:"By country of birth"},
  equityCat:{
    education:{primary:"Pre-secondary",secondary:"Secondary",post_secondary:"Post-secondary"},
    income:{q1:"Quintile 1 (lowest)",q2:"Quintile 2",q3:"Quintile 3",q4:"Quintile 4",q5:"Quintile 5 (highest)"},
    birth_country:{sweden:"Sweden",other_nordic:"Rest of the Nordics",other_europe:"Rest of Europe",other_world:"Rest of the world"},
  },
  equitySrc:"Folkhälsomyndigheten Folkhälsodata (Nationella folkhälsoenkäten / HLV)",
  ...
  realCaveat:{
    ...
    psych:"Split into 78 individual ICD-10 codes grouped into 11 chapters, annual, every age and sex — specialist care only. See the type picker and the note below.",
  ...
  psychBlocks:{
    b0501:"01 – Organic, including symptomatic, mental disorders",
    b0502:"02 – Mental and behavioural disorders due to psychoactive substance use",
    b0503:"03 – Schizophrenia, schizotypal and delusional disorders",
    b0504:"04 – Mood [affective] disorders",
    b0505:"05 – Neurotic, stress-related and somatoform disorders",
    b0506:"06 – Behavioural syndromes associated with physiological disturbances and physical factors",
    b0507:"07 – Disorders of adult personality and behaviour",
    b0508:"08 – Mental retardation",
    b0509:"09 – Disorders of psychological development",
  ...
  notNumB:{
    ...
    psych:"Counts specialist care only. Most ordinary depression is managed in primary care and does not appear here at all. Each type in the picker is a single ICD-10 (International Classification of Diseases, 10th revision) code, grouped by its chapter — not a broad chapter-wide figure like \"eating disorders\" or \"ADHD\", where the named diagnosis was only the most common of several different conditions grouped together.",
