...
function viewVantetider(){
  ...
  <div class="card mt-fig"${dim}>
    <div class="card-h"><h3>${esc(t.timeTitle)}</h3><div class="u">${esc(R[1])} · ${esc(monthLabel(months[0]))}–${esc(monthLabel(latest))}${fetchedTag}</div></div>
  ...
  <div class="grid-ex mt-fig">
    <div class="card"${dim}>
      <div class="card-h"><h3>${esc(t.mapTitle)}</h3><div class="u">${esc(t.vantetiderInd)} (${esc(unit)}) · ${esc(allRegionsLabel())} · ${esc(monthLabel(latest))}${fetchedTag}</div></div>
      <div class="card-b">
